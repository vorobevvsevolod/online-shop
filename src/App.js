  ...
  return (
    <div className="wrapper clear">
        <div style={{display: 'none'}} className="overlay">
            <div className="drawer">
                <h2 className='d-flex justify-between'>Корзина
                    <img src="/img/close-x.svg" alt="close"/>
                </h2>
                <div className="items">
                    <div className="cartItem">
                        <img className='mr-20' width={70} height={70} src="/img/snekears/img%201.jpg" alt="Sneakers"/>
                        <div className='mr-20'>
                ...
                <div className="CardTotalBlock">
                    <div className='TotalCartSum'>
                        <span>Итого:</span>
                        <div></div>
                        <b>21 498 руб.</b>
                    </div>
                    <button className='GreenButton ArrowRight'>Оформить заказ <img src="/img/arrow.svg" alt="arrow"/></button>
                </div>
      ...
      <div className='d-flex align-center'>
        ...
        <div className='ml-20'>
          <h3 className='text-uppercase'>Snikears.io</h3>
        ...
        <ul className='d-flex'>
          <li className='mr-30'>
              ...
              <span className='rubles-card'>1205 руб.</span>
          </li>
            <li className='mr-30'>
